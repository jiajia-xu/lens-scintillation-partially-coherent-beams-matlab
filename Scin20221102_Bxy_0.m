...
P=( 1 - (4.*(Ax.^2.*Ay.^2.*omiga_xx.^2.*omiga_yy.^2   )./(Ax.^2.*omiga_xx.^2 + Ay.^2.*omiga_yy.^2 ) )   ).^0.5;
...
%%
Sintillation_focus=(omiga_xx.^4+omiga_yy.^4)./(omiga_xx.^2+omiga_yy.^2).^2;
%%
...
%hold on
%%
xlabel('\delta_{\ityy}  [mm]','Fontsize',26,'Fontname','Times');
ylabel('\sigma^2_{\itF}','Fontsize',26,'Fontname','Times');
set(gca,'fontname','Times New Roman','FontSize',22);
set(gca,'fontname','Times New Roman','FontSize',22);
%title('\sigma^2 at focus','fontname','Times New Roman','FontSize',20)
...
%%
%hold on
%legend('\sigma^2_{\itF}','\sigma^2_{i}')
